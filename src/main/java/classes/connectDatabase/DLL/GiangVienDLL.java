...
public class GiangVienDLL extends ConnectionDB{
    public GiangVienDLL(){
        super();
    }
    public GiangVienDLL(String Name_DB,String username,String password,String host,String port)
    {
        super(Name_DB,username,password,host,port);
    }
    public GiangVienDLL(String Name_DB, String username,String password)
    {
