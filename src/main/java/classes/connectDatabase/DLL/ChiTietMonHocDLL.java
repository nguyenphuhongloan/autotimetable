...
public class ChiTietMonHocDLL extends ConnectionDB {
    public ChiTietMonHocDLL(){
        super();
    }
    public ChiTietMonHocDLL(String Name_DB,String username,String password,String host,String port)
    {
        super(Name_DB,username,password,host,port);
    }
    public ChiTietMonHocDLL(String Name_DB, String username,String password)
    {
